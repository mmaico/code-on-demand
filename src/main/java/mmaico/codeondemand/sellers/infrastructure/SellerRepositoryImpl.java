...
public class SellerRepositoryImpl implements SellerRepository {
    ...
    public SellerRepositoryImpl() {
        database.put("1", new Seller("1", "Jaime Lannister", new Date(), "92170410090", "11987569852",
                "jlannister@got.com"));
        database.put("2", new Seller("2", "Sansa Stark", new Date(), "10782412017", "11932547896",
                "sstark@got.com"));
        database.put("3", new Seller("3", "Jon Snow", new Date(), "47728435078", "11921478965",
                "sstark@got.com"));
    }
